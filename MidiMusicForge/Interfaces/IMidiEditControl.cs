...
namespace MidiMusicForge.Interfaces
{
    public interface IMidiEditControl
    {
        ...
        IMidiEditControl? SourceTileControl { get; set; }
        IMidiEditControl? DestinationTileControl { get; set; }
